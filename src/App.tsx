...
function JournalTab({ filtered, allCategories, categoryGroups, transactions, setTransactions, rules, setRules }: {
  ...
  const startEdit = (t: Transaction) => { setEditingId(t.id); setEditForm({ date: t.date, category: t.category, type: t.type, amount: t.amount }); };
      ...
      <Panel title="Journal des transactions" subtitle={`${sorted.length} transaction(s) filtrée(s) sur ${transactions.length} au total`}
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead><tr>{["Date", "Catégorie", "Type", "Groupe", "Montant", ""].map((h, i) => (
...
// MAIN APP
// ============================================================
type Tab = "saisie" | "apercu" | "flux" | "comparatif" | "mensuel" | "journalier" | "categories" | "groupes" | "enveloppes" | "simulateur" | "objectif" | "business" | "creances" | "journal" | "export";
